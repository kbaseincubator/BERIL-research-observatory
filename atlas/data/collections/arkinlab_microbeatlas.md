---
id: data.arkinlab-microbeatlas
title: Arkinlab Microbeatlas
type: data_collection
status: draft
summary: Live BERDL collection in the Arkinlab tenant with 5 discovered tables.
source_projects: []
source_docs:
...
`arkinlab_microbeatlas` is a live BERDL database in the Arkinlab tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 5 tables. Key tables include: `enriched_metadata`, `enriched_metadata_gee`, `otu_counts_long`, `otu_metadata`, `sample_metadata`
