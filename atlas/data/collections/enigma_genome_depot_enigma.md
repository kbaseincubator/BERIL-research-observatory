---
id: data.enigma-genome-depot-enigma
title: Enigma Genome Depot Enigma
type: data_collection
status: draft
summary: Live BERDL collection in the ENIGMA tenant with 32 discovered tables.
source_projects: []
source_docs:
...
# Enigma Genome Depot Enigma

## Why This Collection Matters

`enigma_genome_depot_enigma` is a live BERDL database in the ENIGMA tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 32 tables. Key tables include: `browser_annotation`, `browser_cazy_family`, `browser_cog_class`, `browser_config`, `browser_contig`, `browser_ec_number`, `browser_eggnog_description`, `browser_gene`, `browser_genome`, `browser_genome_tags`, `browser_go_term`, `browser_kegg_ortholog`, and 20 more.
