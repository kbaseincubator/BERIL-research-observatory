...
status: draft
summary: Live BERDL collection in the Netl tenant with 1 discovered tables.
source_projects: []
source_docs:
...
`netl_pw_dna` is a live BERDL database in the Netl tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 1 tables. Key tables include: `dna_metadata`
