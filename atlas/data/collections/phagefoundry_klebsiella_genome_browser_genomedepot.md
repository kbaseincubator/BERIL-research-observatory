---
id: data.phagefoundry-klebsiella-genome-browser-genomedepot
title: Klebsiella
type: data_collection
status: draft
summary: Klebsiella genome browser
source_projects:
  []
source_docs:
...
`phagefoundry_klebsiella_genome_browser_genomedepot` is a BERDL database in the PhageFoundry tenant. Klebsiella genome browser
