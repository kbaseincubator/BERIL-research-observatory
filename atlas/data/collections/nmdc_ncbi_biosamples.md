---
id: data.nmdc-ncbi-biosamples
title: NMDC BioSamples
type: data_collection
status: draft
summary: Harmonized NCBI BioSample metadata
source_projects:
  []
source_docs:
...
`nmdc_ncbi_biosamples` is a BERDL database in the NMDC tenant. Harmonized NCBI BioSample metadata
