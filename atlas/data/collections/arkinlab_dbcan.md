---
id: data.arkinlab-dbcan
title: Arkinlab Dbcan
...
`arkinlab_dbcan` is a live BERDL database in the Arkinlab tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 5 tables. Key tables include: `dbcan_integrated_results`, `dbcan_pul`, `fam_substrate_mapping`, `genomad_summary`, `t4ss_structural_validation`
