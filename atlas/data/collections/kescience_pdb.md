---
id: data.kescience-pdb
title: PDB
type: data_collection
status: draft
summary: Protein Data Bank experimental structure metadata (resolution, R-factors, method, organism) and PDB→UniProt chain mapping from SIFTS. Joinable to AlphaFold and pangenome via UniProt accession.
source_projects:
  []
source_docs:
...
`kescience_pdb` is a BERDL database in the KE Science tenant. Protein Data Bank experimental structure metadata (resolution, R-factors, method, organism) and PDB→UniProt chain mapping from SIFTS. Joinable to AlphaFold and pangenome via UniProt accession.
