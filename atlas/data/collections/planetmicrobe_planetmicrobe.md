---
id: data.planetmicrobe-planetmicrobe
title: PlanetMicrobe
type: data_collection
status: draft
summary: Marine microbial ecology (campaigns, samples, metagenomics)
source_projects:
  []
source_docs:
  - docs/collections.md
...
`planetmicrobe_planetmicrobe` is a BERDL database in the PlanetMicrobe tenant. Marine microbial ecology (campaigns, samples, metagenomics)
