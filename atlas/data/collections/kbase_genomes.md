---
id: data.kbase-genomes
title: Genomes
type: data_collection
status: draft
summary: Structural genomics data (contigs, features, protein sequences) in CDM format
source_projects:
  []
source_docs:
...
`kbase_genomes` is a BERDL database in the KBase tenant. Structural genomics data (contigs, features, protein sequences) in CDM format

## What It Contains

The snapshot records 6 tables. Key tables include: `contig_collection`, `contig`, `feature`, `encoded_feature`, `protein`, `name`.
