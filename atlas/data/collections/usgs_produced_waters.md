---
id: data.usgs-produced-waters
title: Usgs Produced Waters
type: data_collection
status: draft
summary: Live BERDL collection in the Usgs tenant with 4 discovered tables.
source_projects: []
source_docs:
...
`usgs_produced_waters` is a live BERDL database in the Usgs tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 4 tables. Key tables include: `data_dictionary`, `data_sources`, `usgspwdb_c`, `usgspwdb_n`
