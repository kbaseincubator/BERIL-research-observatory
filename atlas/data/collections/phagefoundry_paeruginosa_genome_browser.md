---
id: data.phagefoundry-paeruginosa-genome-browser
title: P. aeruginosa
type: data_collection
status: draft
summary: P. aeruginosa genome browser
source_projects:
  []
source_docs:
...
`phagefoundry_paeruginosa_genome_browser` is a BERDL database in the PhageFoundry tenant. P. aeruginosa genome browser
