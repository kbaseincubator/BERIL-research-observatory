---
id: data.phagefoundry-acinetobacter-genome-browser
title: Acinetobacter
type: data_collection
status: draft
summary: Acinetobacter genome browser
source_projects:
  []
source_docs:
  - docs/collections.md
...
`phagefoundry_acinetobacter_genome_browser` is a BERDL database in the PhageFoundry tenant. Acinetobacter genome browser
