---
id: data.phagefoundry-pviridiflava-genome-browser
title: P. viridiflava
type: data_collection
status: draft
summary: P. viridiflava genome browser
source_projects:
  []
source_docs:
  - docs/collections.md
...
`phagefoundry_pviridiflava_genome_browser` is a BERDL database in the PhageFoundry tenant. P. viridiflava genome browser
