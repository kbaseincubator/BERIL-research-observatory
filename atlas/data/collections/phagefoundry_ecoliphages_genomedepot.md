---
id: data.phagefoundry-ecoliphages-genomedepot
title: Phagefoundry Ecoliphages Genomedepot
type: data_collection
status: draft
summary: Live BERDL collection in the PhageFoundry tenant; no tables were visible
  in the latest table-only discovery.
source_projects: []
source_docs:
...
# Phagefoundry Ecoliphages Genomedepot

## Why This Collection Matters

`phagefoundry_ecoliphages_genomedepot` is a live BERDL database in the PhageFoundry tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.
