---
id: data.kescience-webofmicrobes
title: Web of Microbes
type: data_collection
status: draft
summary: "Curated microbial exometabolomics: metabolite production/excretion profiles (Kosina et al. 2018)"
source_projects:
  []
source_docs:
...
`kescience_webofmicrobes` is a BERDL database in the KE Science tenant. Curated microbial exometabolomics: metabolite production/excretion profiles (Kosina et al. 2018)
