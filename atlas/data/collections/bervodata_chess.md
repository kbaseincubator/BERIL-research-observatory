---
id: data.bervodata-chess
title: Bervodata Chess
type: data_collection
status: draft
summary: Live BERDL collection in the Bervodata tenant with 5 discovered tables.
source_projects: []
source_docs:
...
`bervodata_chess` is a live BERDL database in the Bervodata tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 5 tables. Key tables include: `ddt_ndarray`, `geophysical_survey_emi_survey`, `geophysical_survey_tdr_plot_data`, `sys_ddt_typedef`, `sys_oterm`
