---
id: data.enigma-coral
title: ENIGMA CORAL
type: data_collection
status: draft
summary: Environmental microbiology data from the ENIGMA SFA (samples, genomes, communities, strains)
source_projects:
  []
source_docs:
...
`enigma_coral` is a BERDL database in the ENIGMA tenant. Environmental microbiology data from the ENIGMA SFA (samples, genomes, communities, strains)

## What It Contains

The snapshot records 4 tables. Key tables include: `sdt_location`, `sdt_taxon`, `sdt_strain`, `sdt_condition`.
