---
page_id: claim:adp1-triple-continuous-fitness-claim
page_type: claim
member_hash: hash:5819c23f202a24c9
---
...
- Page type: `claim`
- Member hash: `hash:5819c23f202a24c9`
- Graph: [Graph](../graph.md)

## Introduction

This claim page evaluates the statement: ADP1 essentiality synthesis should prioritize continuous fitness and orthogonal evidence over binary essentiality thresholds alone. [stmt:adp1-triple-continuous-fitness-claim; adp1_triple_essentiality]. It collects supporting findings, caveats, and downstream uses selected by the deterministic page plan.
...
This page links out to 9 related pages and has 13 backlinks. Use those links to move between the prose note, the underlying evidence, and the graph neighborhood.
