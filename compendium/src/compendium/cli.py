...
def main(argv: list[str] | None = None) -> int:
    ...
    export_cosma = sub.add_parser("export-cosma")
    export_cosma.add_argument("path")
    export_cosma.add_argument("--source-root", default="../projects")
    export_cosma.add_argument("--wiki", required=True)
    export_cosma.add_argument("--out", required=True)
    export_cosma.add_argument("--title", default="Compendium")
