...
def main(argv: list[str] | None = None) -> int:
    ...
    synthesize_page = sub.add_parser("synthesize-page")
    synthesize_page.add_argument("path")
    synthesize_page.add_argument("--page-id", required=True)
    synthesize_page.add_argument("--out", required=True)
    synthesize_page.add_argument("--model", default="deterministic-section-list")
    synthesize_page.add_argument("--prompt-hash", default="prompt:deterministic-section-list")
