---
id: data.kescience-interpro
title: Kescience Interpro
type: data_collection
status: draft
summary: Live BERDL collection in the KE Science tenant with 3 discovered tables.
source_projects: []
source_docs:
...
`kescience_interpro` is a live BERDL database in the KE Science tenant. This scaffold page makes the collection visible to humans and agents even before a domain-specific curator has written a richer interpretation.

## What It Contains

The live Spark inventory records 3 tables. Key tables include: `entry`, `go_mapping`, `protein2ipr`
