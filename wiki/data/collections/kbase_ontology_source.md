---
id: data.kbase-ontology-source
title: Ontology
type: data_collection
status: draft
summary: Ontology definitions (timed out during discovery)
source_projects:
  []
source_docs:
  - docs/collections.md
...
`kbase_ontology_source` is a BERDL database in the KBase tenant. Ontology definitions (timed out during discovery)
