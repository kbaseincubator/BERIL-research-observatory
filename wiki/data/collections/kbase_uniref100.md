---
id: data.kbase-uniref100
title: UniRef100
type: data_collection
status: draft
summary: UniRef protein clusters at 100% identity
source_projects:
  []
source_docs:
  - docs/collections.md
...
`kbase_uniref100` is a BERDL database in the KBase tenant. UniRef protein clusters at 100% identity

## What It Contains

The snapshot records 1 table. Key tables include: `clustermember`.
