...
This layer is provider-agnostic and streaming-agnostic: the step-5 SSE
endpoint will share the same persistence logic by consuming events from
:func:`run_provider_turn` directly.
"""
