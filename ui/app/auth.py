"""ORCiD OAuth2 authentication for the BERIL Research Observatory."""
...
async def login(request: Request):
    ...
    # Store where to return after login (default: home)
...
async def orcid_callback(request: Request, code: str | None = None, error: str | None = None):
    ...
    try:
        ...
        # ORCiD returns the iD and name directly in the token response
