...
- Relations: 32
- Hypotheses: 20 (rejected=8, testing=1, validated=11)
- Timeline events: 43
...
- Unknown entity IDs referenced in hypotheses (0): _None_
- Unknown project IDs referenced by entities (0): _None_
- Unknown project IDs referenced by relations (0): _None_
- Unknown project IDs referenced by hypotheses (0): _None_
- Unknown project IDs referenced by timeline events (0): _None_
- Isolated entities with no relation edges (40): `conc_functional_dark_matter`, `conc_module_transfer`, `conc_nadh_flux_rate`, `conc_respiratory_wiring`, `conc_selection_signature`, `conc_two_speed_genome`, `conc_variable_essentiality`, `gene_fusa`, `gene_groel`, `gene_ndh2`, `gene_pca_pathway`, `gene_phab`, `gene_pyrg`, `gene_urease_complex`, `gene_vals`, ... (+25 more)
