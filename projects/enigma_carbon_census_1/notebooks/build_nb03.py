...
cells = [
    ("md", "# NB03 — Organism Mapping (ENIGMA isolates, reaction bridge)\n\n"
           ...
           "Three reactions qualify for the allowlist — **R02107** (xanthine→urate, xanthine oxidase), "
           "**R02612** (phenethylamine→phenylacetaldehyde, deaminating amine oxidase), **R07202** "
