...
TENANT_TO_AGENCY = {
    ...
    "msyscolo":     {"agency": "DOE/NSF",        "program": "Microbial Ecosystems Lab (CSU)",        "primary_funder": "DOE + NSF"},
    ...
    "phagefoundry": {"agency": "DOE",            "program": "BRaVE (Phage Foundry)",                  "primary_funder": "DOE"},
