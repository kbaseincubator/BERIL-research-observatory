...
## Status
Active — plan v2 approved 2026-06-04 (after Claude plan review `PLAN_REVIEW_1.md`); analysis underway starting with NB01 (Leaden 2018 Fur-only signature). Phase A orientation (`notebooks/00_orientation.ipynb`) and literature review (`references.md`) complete.
