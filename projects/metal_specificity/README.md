...
## Status
Completed — 54% of metal-important genes are metal-specific (sick rate <5% under non-metal conditions), but these remain 88% core-enriched. The core genome robustness model holds even after controlling for specificity. YebC is the most metal-specific novel candidate (64%).
