"""Concat per-paper titlesearch codex TSVs into manuscript-summaries-titlesearch.tsv."""
...
SUM_DIR = PROJECT_DATA / "codex_summaries_titlesearch"
PER_PAPER_DIR = SUM_DIR / "per_paper"
OUT_PATH = PROJECT_DATA / "manuscript-summaries-titlesearch.tsv"
