"""
Concat per-paper Codex summaries for the positive 500-gene set into
data/manuscript-summaries-positive.tsv (4-col schema, same as the
recalcitrant-set manuscript-summaries.tsv).
"""
...
SUM_DIR = PROJECT_DATA / "codex_summaries_positive"
PER_PAPER_DIR = SUM_DIR / "per_paper"
OUT_PATH = PROJECT_DATA / "manuscript-summaries-positive.tsv"
