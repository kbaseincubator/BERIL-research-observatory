"""
Concat per-paper Codex summaries from the gapfill run into
data/manuscript-summaries-gapfill.tsv (4-col schema).
"""
...
SUM_DIR = PROJECT_DATA / "codex_summaries_gapfill"
PER_PAPER_DIR = SUM_DIR / "per_paper"
OUT_PATH = PROJECT_DATA / "manuscript-summaries-gapfill.tsv"
