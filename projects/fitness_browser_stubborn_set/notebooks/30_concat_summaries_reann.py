"""
Concat per-paper Codex summaries for the reannotation set into
data/manuscript-summaries-reann.tsv (4-col schema, same as the other
manuscript-summaries TSVs).
"""
...
SUM_DIR = PROJECT_DATA / "codex_summaries_reann"
PER_PAPER_DIR = SUM_DIR / "per_paper"
OUT_PATH = PROJECT_DATA / "manuscript-summaries-reann.tsv"
