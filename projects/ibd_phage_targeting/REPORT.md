...
These two narratives converge on **complementary cocktail-design implications** that Pillar 4–5 will operationalize:

| Pathobiont | Iron specialization | Bile-acid 7α-dehydroxylation | Cocktail-design profile |
|---|---|---|---|
| ***E. coli*** | dominant | NOT in network | Target AIEC-subset specifically (Yersiniabactin/Enterobactin/Colibactin-positive); strain-content-mediated; LOW BA-coupling cost |
| ***M. gnavus*** | none | NOT in network | Target broadly (mucin glucorhamnan); LOW BA-coupling cost |
| ***H. hathewayi*** | none | NOT in network | Target broadly (TMA/choline producer); LOW BA-coupling cost |
| ***F. plautii*** | weak | **active 7α-dehydroxylator** | Species-abundance-mediated; **HIGHEST BA-coupling cost** (depletion shifts BA pool toward inflammatory primary tauro-conjugated forms) |
| ***E. bolteae*** | none | active 7α-dehydroxylator | MODERATE BA-coupling cost |
| ***E. lenta*** | none | partial 7α-dehydroxylator | MODERATE BA-coupling cost; primary CD-association via drug-metabolism (Koppel 2018) |

### What this report does not yet contain

The H3 falsifiability framework is now fully closed (all 8 sub-hypotheses tested). **NB07d MOFA+ HMP2-only multi-omics pilot** remains as an exploratory extension. **Pillars 4–5** (phage targetability matrix; UC Davis per-patient cocktail drafts) land in subsequent syntheses.
