...
- ✅ **NB05 Tier-A scoring (A3–A6) — Pillar 2 closed**: 71 unique rigor-controlled candidates scored; **6 actionable** (total ≥ 2.5/4.0): *H. hathewayi* (4.0), *M. gnavus* (3.8), *E. coli* (3.6; Colibactin+Yersiniabactin+Enterobactin MIBiG matches), *E. lenta* (3.3), *F. plautii* (3.3), *E. bolteae* (2.8). 9 Tier-B sub-threshold candidates (incl. *S. salivarius* with Salivaricin MIBiG matches). Hand-off to Pillar 4/5.
