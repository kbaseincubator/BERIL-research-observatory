...
## Post-Review Status (2026-06-30)

The following suggestions from the 2026-05-02 review have been addressed:

| # | Suggestion | Status |
|---|---|---|
| 1 | Create `RESEARCH_PLAN.md` (broken link) | **Done** — file exists |
| 6 | Move unlisted markdown files to `notes/` | **Done** — all analysis summaries are in `notes/` |
| 7 | Document `clade_specific_sensitivity.ipynb` | **Done** — listed in README Quick Links with run instructions |

The following remain open:

| # | Suggestion | Status |
|---|---|---|
| 2 | Add `renv.lock` for R reproducibility | Open |
| 3 | Clarify S1 leave-one-metal-out ambiguity | Open |
| 4 | Flag Track B CWM coverage gap as formal limitation | Open |
| 5 | Elevate Track A fold-enrichment non-result to table | Open |
| 8 | Complete Zenodo deposit | Open (DOI pending) |

**Project scope update**: The project has grown significantly since this review. Chapters 07–11 were appended to REPORT.md on 2026-06-30 (COG functional genomics, OTU-level GeoROC, global MAG biogeography, biome-stratified Pagel's λ, gene × biome enrichment, AlphaEarth embedding synthesis). A second adversarial review of Ch.11 (NB11c) was conducted on 2026-06-30; key finding: PC12 dose-response (ρ=+0.68) does not survive BH-FDR correction (q=0.125) and is marked exploratory. These chapters were not in scope for the original review above.
